...
export function activate(context: vscode.ExtensionContext) {
  try {
    ...
    context.subscriptions.push(
      // Core commands
      vscode.commands.registerCommand("pr-buildr.createPR", () => createPRCommand(context)),
      vscode.commands.registerCommand("pr-buildr.setBase", () => setBaseCommand()),
      vscode.commands.registerCommand("pr-buildr.showBase", () => showBaseCommand()),
      vscode.commands.registerCommand("pr-buildr.clearBase", () => clearBaseCommand()),
      vscode.commands.registerCommand("pr-buildr.regenerate", () => regenerateCommand()),
      ...
      vscode.commands.registerCommand("pr-buildr.githubReauth", () => githubReauthCommand(context)),
    );

    console.log("PR Buildr: activated successfully — 9 commands registered");
  } catch (err) {
